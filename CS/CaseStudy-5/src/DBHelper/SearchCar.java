...
public class SearchCar {
	public static Map<Integer,Vehicle> searchByMake(Connection con,String make) {
		//Connection con = null;
	...
	public static Map<Integer,Vehicle> searchByVehicleID(Connection con,int vehicleID) {
		//Connection con = null;
		PreparedStatement ps = null;
		//con = ConnectionUtil.getConnection();
