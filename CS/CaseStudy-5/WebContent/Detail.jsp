...
<%!Vehicle vehicle = null; %>
	<div class="image">
		<img src="View/Images/bmw1series.jpg" width="100%" height="100%">
	</div>
	<div class="detail">
		<h1>Details</h1>
	<table>
	...
	<div class = "box">
		...
		<table>
			<tr>
				<td>Milage</td>
				<td><%out.print(vehicle.getMilage()); %></td>
			</tr>
			<tr>
				<td>Service Cost</td>
				<td>---</td>
	...
	<table>
		<tr>
			<td>Engine</td>
			<td><%out.print(vehicle.getEnginInCC()); %></td>
		</tr>
		<tr>
			<td>BHP</td>
			<td>148</td>
	...
	<div class = "box">
		...
		<tr>
			...
			<td><%out.print(((Car)vehicle).isPowerSteering()); %></td>
		</tr>
		<tr>
			<td>AC</td>
			<td><%out.print(((Car)vehicle).isPowerSteering()); %></td>
	...
	<div class = "box">
		...
		<table>
			<tr>
				<td>Accessory Kit</td>
				<td><%out.print(((Car)vehicle).isAccessoryKit()); %></td>
			</tr>
			<tr>
	...
	<div class="slide">
		<marquee direction="left" width="100%" height="100%">
			<img src="View/Images/bmw1seriesslide.jpg" height="300px" border="40px">
		</marquee>
	</div>
</body>
</html>