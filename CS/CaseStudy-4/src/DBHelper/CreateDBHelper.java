...
/**
 * Servlet implementation class createDBHelper
 */
@WebServlet("/CreateDBHelper")
public class CreateDBHelper extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public CreateDBHelper() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//System.out.println("hii"+request.getParameter("showRoomPrice"));
